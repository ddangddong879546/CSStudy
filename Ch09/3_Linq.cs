 ...
 * 
 * Linq
 * - Linq(Language intergrated Query)는 컬렉션을 대상으로 데이터를 가공처리하기 위한 C# 질의언어
 * - Linq를 사용해서 DB(Data Base) 와 함께 데이터를 쉽게 관리
 */
namespace Ch09
{
    class Member
    ...
    internal class _3_Linq
    {
        static void Main1(string[] args)
        {
            ...
            Console.WriteLine("rsList 4 : " + String.Join(", ", rsList4));
