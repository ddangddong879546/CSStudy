...
namespace CSStudy_1_
{
    internal class _6_문자열
    {
        static void Main1(string[] args)
        {
            ...
            Console.WriteLine("'o'인덱스 :" + greeting.LastIndexOf('o'));  //뒤에서부터
            Console.WriteLine();


            //문자열 자르기
            Console.WriteLine("greeting0-4까지 문자열 : " + greeting.Substring(0, 4));
            Console.WriteLine("greeting5-7까지 문자열 : " + greeting.Substring(5, 7));
            Console.WriteLine("greeting5-마지막까지 문자열 : " + greeting.Substring(5));
            Console.WriteLine();
